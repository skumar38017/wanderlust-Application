...
export default function PostCard({ post, testId = 'postcard' }: { post: Post } & TestProps) {
  ...
  return (
    <div className="group w-full md:w-1/2 lg:w-1/3 xl:w-1/4 mb-4 md:mr-8 md:mt-4" data-testid={testId}>
      <div className="cursor-pointer rounded-lg bg-light shadow-md dark:bg-dark-card" onClick={handlePostClick}>
        <div className="h-48 w-full overflow-hidden">
          <img
            src={post.imageLink}
            alt={post.title}
            className="h-full w-full rounded-t-lg object-cover transition-transform ease-in-out"
          />
        </div>
        <div className="p-3">
...
//       data-testid={testId}
//       <div className={`scale-click group w-full md:w-1/2 lg:w-1/3 xl:w-1/4`} data-testid={testId}><div>
